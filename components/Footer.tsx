    ...
    <footer className="bg-backgroundSecondary text-center py-4 block relative z-0">
            <div className="container mx-auto">
                ...
                <div className="flex justify-center gap-4 text-textTertiary text-xl">
                    <a href="mailto:louis.chabanon@gadz.org" aria-label="Email" onClick={() => posthog.capture('mail_click_event')}>
                        <MailOutlined />
                    </a>
                    <a href="https://github.com/LouisChabanon/better-lise" target="_blank" rel="noopener noreferrer" aria-label="GitHub" onClick={() => posthog.capture('github_click_event')}>
                        <GithubOutlined />
                    </a>
                </div>
            </div>
