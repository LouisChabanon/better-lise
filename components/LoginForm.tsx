    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6">
            <div className="flex items-center gap-4">
                <label htmlFor="username" className="w-40 font-medium text-gray-800">Identifiant :</label>
            ...
            <div className="flex items-center gap-4">
                <label htmlFor="Password" className="w-40 font-medium text-gray-800">Mot de passe :</label>
                <div className="flex items-center px-3 py-2 w-full bg-surface rounded-lg  focus-within:ring-1 focus-within:ring-primary-400 hover:ring-1 hover:ring-primary-400">
            ...
            {errors && (
                <div className="p-4 bg-error-container border border-error text-error rounded-md">
                    {errors}
                </div>
            )}
            <div>
                <Button type="submit" className="w-full" disabled={loading}><span className="font-semibold text-lg">{loading ? "Connexion..." : "Connexion"}</span></Button>
            </div>
        </form>
    )
}