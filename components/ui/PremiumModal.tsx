			...
			{isOpen && (
				<div className="fixed inset-0 z-[60] flex items-center justify-center p-4 sm:p-6">
					...
					<m.div
						...
						className="relative w-full max-w-[480px] bg-backgroundPrimary text-textPrimary rounded-3xl overflow-hidden shadow-2xl border border-black/5 dark:border-white/10"
					>
						...
						<div className="relative p-7 pb-5">
							...
							<p className="text-textSecondary text-[15px] leading-relaxed mb-6">
							...
							{/* Pricing Card */}
							<div className="bg-backgroundSecondary border border-black/5 dark:border-white/10 hover:border-indigo-500/30 dark:hover:border-indigo-500/30 transition-colors rounded-2xl p-5 relative overflow-hidden group mb-1">
						...
						<div className="p-7 space-y-6">
							<div className="flex gap-4">
								<div className="w-10 h-10 rounded-xl bg-indigo-500/10 flex items-center justify-center shrink-0 border border-indigo-500/20 shadow-inner">
									<RobotOutlined className="text-indigo-500 dark:text-indigo-400 text-xl" />
								</div>
								<div>
							...
							<div className="flex gap-4">
								...
								<div>
									<h3 className="text-base font-bold text-textPrimary mb-1.5 flex items-center gap-2">
										Accès ENIM
										<CheckCircleFilled className="text-purple-500 text-sm" />
									</h3>
									<p className="text-[13px] text-textSecondary leading-relaxed">
							...
							<div className="flex gap-4">
								<div className="w-10 h-10 rounded-xl bg-amber-500/10 flex items-center justify-center shrink-0 border border-amber-500/20 shadow-inner">
									<RocketOutlined className="text-amber-500 dark:text-amber-400 text-xl" />
								</div>
								<div>
									<h3 className="text-base font-bold text-textPrimary mb-1.5 flex items-center gap-2">
										Masterclass Entrepreneur
										<CheckCircleFilled className="text-amber-500 text-sm" />
									</h3>
									<p className="text-[13px] text-textSecondary leading-relaxed">
